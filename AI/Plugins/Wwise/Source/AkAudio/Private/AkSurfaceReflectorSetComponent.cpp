...
void UAkSurfaceReflectorSetComponent::SendSurfaceReflectorSet() const
{
	...
	if (AkAudioDevice && ShouldSendGeometry())
	{
		...
		{
			AkAudioDevice->AddGeometrySet(AkGeometrySetID(this), TrianglesToSend.GetData(), TrianglesToSend.Num());
		}
	}
}

void UAkSurfaceReflectorSetComponent::RemoveSurfaceReflectorSet() const
{
	FAkAudioDevice* AkAudioDevice = FAkAudioDevice::Get();
	if (AkAudioDevice && ShouldSendGeometry())
		AkAudioDevice->RemoveGeometrySet(AkGeometrySetID(this));
}

void UAkSurfaceReflectorSetComponent::UpdateSurfaceReflectorSet() const
{
